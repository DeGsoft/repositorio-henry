...
createdBy.innerHTML = createdBy.innerHTML + "Aplicación creada por Franco";
...
const nuevaTarea = new ToDo("Estudiar para el checkpoint")
...
function buildToDo(todo, index) {
  // Tu código acá:
  var toDoSell = document.createElement("div");
  toDoSell.classList.add("toDoShell");
